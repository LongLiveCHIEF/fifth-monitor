const Hexer = require('string-hexer');
...
SivaNodeSanitizer.prototype._transform = function(row, encoding, cb){
  ...
  this.push(JSON.stringify({
	he: row[ORIGINAL_NODE_HEADER],
  	original: row[ORIGINAL_NODE_HEADER],
  	fwding_hex: row[MUTATED_NODE_HEADER],
	fwding_original: row[MUTATED_NODE_HEADER]
  }));
